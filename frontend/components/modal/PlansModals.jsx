      ...
      <thead className="h-[50px] bg-[#fff]">
        <tr className="text-[14px] font-[800] ">
          ...
          <th className=" items-center">
            <PhoneCallbackIcon style={{ color: '#36E2B4', fontSize: '24px' }} />
    ...
    <ul className="mt-[6px]">
      <li className="text-[16px] font-[500]">
        ...
        <span className="text-black">
          زمان انتظار پاسخگویی، زمانی است که پزشک بعد از مطلع شدن از سوال شما تا
          زمانی که پاسختان را میدهد منتظر میمانید، معمولا در اسرع وقت پاسخگوی
          شماست و این زمان، حداکثر مدت انتظار شماست.
        </span>
      </li>
      ...
      <li className="text-[16px] font-[500] mt-[6px]">
        ...
        <span className="text-black">
          پایان توافقی گفتگو به این معنی میباشد که پس از گفتگوی دوطرفه، پزشک از
          دریافت پاسخ کامل سوال شما اطمینان حاصل کرده و به تایید شما گفتگو را
          خواهد بست.
        </span>
      </li>
    </ul>
