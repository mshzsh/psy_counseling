            ...
            <>
              <div className="flex w-full justify-between">
                <div className="text-[14px] font-[800] text-black">
                  ...
                  {timer < 120 && `کد به ${toFaDigit(numb)} ارسال شد`}
                </div>
              ...
              {timer < 120 ? (
                ...
                <input
                  ...
                  className="w-full text-[16px] font-[600] outline-none bg-[#F9F9F9] px-[16px] py-[11px] mt-[8px] mb-[16px]"
                  style={{ direction: 'ltr' }}
                />
              )}
              ...
              {!startTimer && timer === 120 && (
                <button
                  ...
                  onClick={async () => {
                    ...
                    await axios
                      .post('https://api.haalekhoob.net/users/login/', {
                        OTP: getOtp,
                        mobile: mobileNumber,
                        password,
                      })
          ...
          {!getOtp && !hasPassword && (
            <div className="w-full flex flex-col">
              ...
              <button
                ...
                onClick={() => {
                  axios
                    .post('https://api.haalekhoob.net/users/pre-login/', {
                      mobile: mobileNumber,
                    })
                    .then(({ data }) => {
                      setGetOtp(data.otp)
